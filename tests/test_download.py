from newface.download import get_static_download_size, ping_static_url, resolve_download_url_by_provider
...
def test_get_static_download_size() -> None:
	...
	assert get_static_download_size('https://huggingface.co/newface/models-3.0.0/resolve/main/fairface.onnx') == 85170772
...
def test_resolve_download_url_by_provider() -> None:
	...
	assert resolve_download_url_by_provider('huggingface', 'models-3.0.0', 'fairface.onnx') == 'https://huggingface.co/newface/models-3.0.0/resolve/main/fairface.onnx'

...
import newface.ffmpeg
from newface import process_manager, state_manager
from newface.download import conditional_download
from newface.ffmpeg import concat_video, extract_frames, merge_video, read_audio_buffer, replace_audio, restore_audio
from newface.filesystem import copy_file
from newface.temp_helper import clear_temp_directory, create_temp_directory, get_temp_file_path, resolve_temp_frame_paths
from newface.types import EncoderSet
...
def get_available_encoder_set() -> EncoderSet:
	...
	return newface.ffmpeg.get_available_encoder_set()

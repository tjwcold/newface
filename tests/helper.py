...
from newface.filesystem import create_directory, is_directory, is_file, remove_directory
...
def get_test_jobs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'newface-test-jobs')
...
def get_test_examples_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'newface-test-examples')
...
def get_test_outputs_directory() -> str:
	return os.path.join(tempfile.gettempdir(), 'newface-test-outputs')

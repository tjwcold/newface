...
from newface.common_helper import create_int_metavar
from newface.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from newface.face_analyser import scale_face
from newface.face_helper import paste_back, warp_face_by_face_landmark_5
from newface.face_masker import create_box_mask, create_occlusion_mask
from newface.face_selector import select_faces
from newface.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from newface.processors.live_portrait import create_rotation, limit_expression
from newface.processors.modules.expression_restorer import choices as expression_restorer_choices
from newface.processors.modules.expression_restorer.types import ExpressionRestorerInputs
from newface.processors.types import LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw, ProcessorOutputs
from newface.program_helper import find_argument_group
from newface.thread_helper import conditional_thread_semaphore, thread_semaphore
from newface.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from newface.vision import read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor', 'expression_restorer_areas' ])

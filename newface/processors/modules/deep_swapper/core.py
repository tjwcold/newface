...
from newface.download import conditional_download_hashes, conditional_download_sources, resolve_download_url_by_provider
...
from newface.filesystem import get_file_name, in_directory, is_image, is_video, resolve_file_paths, resolve_relative_path, same_file_extension
from newface.processors.modules.deep_swapper import choices as deep_swapper_choices
from newface.processors.modules.deep_swapper.types import DeepSwapperInputs, DeepSwapperMorph
...
from newface.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
from newface.vision import conditional_match_frame_color, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'deep_swapper_model', 'deep_swapper_morph' ])

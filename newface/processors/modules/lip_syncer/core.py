...
from newface import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, state_manager, translator, video_manager, voice_extractor
from newface.audio import read_static_voice
...
from newface.face_helper import create_bounding_box, paste_back, warp_face_by_bounding_box, warp_face_by_face_landmark_5
from newface.face_masker import create_area_mask, create_box_mask, create_occlusion_mask
from newface.face_selector import select_faces
from newface.filesystem import has_audio, resolve_relative_path
from newface.processors.modules.lip_syncer import choices as lip_syncer_choices
from newface.processors.modules.lip_syncer.types import LipSyncerInputs, LipSyncerWeight
...
from newface.types import ApplyStateItem, Args, AudioFrame, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'lip_syncer_model', 'lip_syncer_weight' ])

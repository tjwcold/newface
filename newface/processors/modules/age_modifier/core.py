...
from newface.common_helper import create_int_metavar, is_macos
...
from newface.face_helper import merge_matrix, paste_back, scale_face_landmark_5, warp_face_by_face_landmark_5
...
from newface.processors.modules.age_modifier import choices as age_modifier_choices
from newface.processors.modules.age_modifier.types import AgeModifierDirection, AgeModifierInputs
from newface.processors.types import ProcessorOutputs
from newface.program_helper import find_argument_group
from newface.thread_helper import thread_semaphore
...
from newface.vision import match_frame_color, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
...
def forward(crop_vision_frame : VisionFrame, extend_vision_frame : VisionFrame, age_modifier_direction : AgeModifierDirection) -> VisionFrame:
	...
	if is_macos() and has_execution_provider('coreml'):
		age_modifier.set_providers([ newface.choices.execution_provider_set.get('cpu') ])

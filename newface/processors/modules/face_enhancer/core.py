...
from newface.common_helper import create_float_metavar, create_int_metavar
...
from newface.processors.modules.face_enhancer import choices as face_enhancer_choices
from newface.processors.modules.face_enhancer.types import FaceEnhancerInputs, FaceEnhancerWeight
...
from newface.vision import blend_frame, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'face_enhancer_model', 'face_enhancer_blend', 'face_enhancer_weight' ])

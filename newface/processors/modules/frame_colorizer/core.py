...
from newface.processors.modules.frame_colorizer import choices as frame_colorizer_choices
from newface.processors.modules.frame_colorizer.types import FrameColorizerInputs
...
from newface.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from newface.vision import blend_frame, read_static_image, read_static_video_frame, unpack_resolution
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])

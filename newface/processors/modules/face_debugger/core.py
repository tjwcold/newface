...
from newface import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, state_manager, translator, video_manager
from newface.face_analyser import scale_face
from newface.face_helper import warp_face_by_face_landmark_5
...
from newface.filesystem import in_directory, is_image, is_video, same_file_extension
from newface.processors.modules.face_debugger import choices as face_debugger_choices
from newface.processors.modules.face_debugger.types import FaceDebuggerInputs
from newface.processors.types import ProcessorOutputs
from newface.program_helper import find_argument_group
from newface.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'face_debugger_items' ])

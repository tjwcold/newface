...
from newface import config, content_analyser, inference_manager, logger, state_manager, translator, video_manager
from newface.common_helper import is_macos, is_windows
...
from newface.normalizer import normalize_color
from newface.processors.modules.background_remover import choices as background_remover_choices
from newface.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from newface.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_fill_color', 'background_remover_despill_color' ])

...
from newface.processors.modules.frame_enhancer import choices as frame_enhancer_choices
from newface.processors.modules.frame_enhancer.types import FrameEnhancerInputs
...
from newface.types import ApplyStateItem, Args, DownloadScope, InferencePool, ModelOptions, ModelSet, ProcessMode, VisionFrame
from newface.vision import blend_frame, create_tile_frames, merge_tile_frames, read_static_image, read_static_video_frame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		newface.jobs.job_store.register_step_keys([ 'frame_enhancer_model', 'frame_enhancer_blend' ])

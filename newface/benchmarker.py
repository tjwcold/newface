...
from newface import core, state_manager
from newface.cli_helper import render_table
from newface.download import conditional_download, resolve_download_url
from newface.face_store import clear_static_faces
from newface.filesystem import get_file_extension
from newface.types import BenchmarkCycleSet
from newface.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ newface.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in newface.choices.benchmark_set ]

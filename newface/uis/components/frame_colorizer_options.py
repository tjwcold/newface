...
def render() -> None:
	...
	FRAME_COLORIZER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.frame_colorizer'),
	...
	FRAME_COLORIZER_SIZE_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.size_dropdown', 'newface.processors.modules.frame_colorizer'),
	...
	FRAME_COLORIZER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'newface.processors.modules.frame_colorizer'),

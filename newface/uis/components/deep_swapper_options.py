...
from newface.processors.modules.deep_swapper.types import DeepSwapperModel
...
def render() -> None:
	...
	DEEP_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.deep_swapper'),
	...
	DEEP_SWAPPER_MORPH_SLIDER = gradio.Slider(
		label = translator.get('uis.morph_slider', 'newface.processors.modules.deep_swapper'),

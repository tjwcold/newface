...
def render() -> None:
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.frame_enhancer'),
	...
	FRAME_ENHANCER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'newface.processors.modules.frame_enhancer'),

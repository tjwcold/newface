...
from newface import state_manager, translator, voice_extractor
from newface.filesystem import is_video
from newface.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = newface.choices.voice_extractor_models,

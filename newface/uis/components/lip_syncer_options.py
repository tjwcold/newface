...
from newface.processors.modules.lip_syncer.types import LipSyncerModel, LipSyncerWeight
...
def render() -> None:
	...
	LIP_SYNCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.lip_syncer'),
	...
	LIP_SYNCER_WEIGHT_SLIDER = gradio.Slider(
		label = translator.get('uis.weight_slider', 'newface.processors.modules.lip_syncer'),

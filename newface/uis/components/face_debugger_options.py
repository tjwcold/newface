...
from newface.processors.modules.face_debugger.types import FaceDebuggerItem
...
def render() -> None:
	...
	FACE_DEBUGGER_ITEMS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		label = translator.get('uis.items_checkbox_group', 'newface.processors.modules.face_debugger'),

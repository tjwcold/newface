...
from newface.processors.modules.age_modifier.types import AgeModifierModel
...
def render() -> None:
	...
	AGE_MODIFIER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.age_modifier'),
	...
	AGE_MODIFIER_DIRECTION_SLIDER = gradio.Slider(
		label = translator.get('uis.direction_slider', 'newface.processors.modules.age_modifier'),

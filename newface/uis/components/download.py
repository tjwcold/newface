...
from newface import face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, state_manager, translator, voice_extractor
...
from newface.types import DownloadProvider
...
def render() -> None:
	...
	DOWNLOAD_PROVIDERS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		choices = newface.choices.download_providers,
...
def update_download_providers(download_providers : List[DownloadProvider]) -> gradio.CheckboxGroup:
	...
	download_providers = download_providers or newface.choices.download_providers

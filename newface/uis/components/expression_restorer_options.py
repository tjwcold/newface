...
from newface.processors.modules.expression_restorer.types import ExpressionRestorerArea, ExpressionRestorerModel
...
def render() -> None:
	...
	EXPRESSION_RESTORER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.expression_restorer'),
	...
	EXPRESSION_RESTORER_FACTOR_SLIDER = gradio.Slider(
		label = translator.get('uis.factor_slider', 'newface.processors.modules.expression_restorer'),
	...
	EXPRESSION_RESTORER_AREAS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		label = translator.get('uis.areas_checkbox_group', 'newface.processors.modules.expression_restorer'),

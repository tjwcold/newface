...
from newface.common_helper import calculate_float_step, get_first
...
from newface.processors.modules.face_swapper.types import FaceSwapperModel, FaceSwapperWeight
...
def render() -> None:
	...
	FACE_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.face_swapper'),
	...
	FACE_SWAPPER_PIXEL_BOOST_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.pixel_boost_dropdown', 'newface.processors.modules.face_swapper'),
	...
	FACE_SWAPPER_WEIGHT_SLIDER = gradio.Slider(
		label = translator.get('uis.weight_slider', 'newface.processors.modules.face_swapper'),

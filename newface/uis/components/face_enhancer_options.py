...
from newface.processors.modules.face_enhancer.types import FaceEnhancerModel, FaceEnhancerWeight
...
def render() -> None:
	...
	FACE_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.face_enhancer'),
	...
	FACE_ENHANCER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'newface.processors.modules.face_enhancer'),
	...
	FACE_ENHANCER_WEIGHT_SLIDER = gradio.Slider(
		label = translator.get('uis.weight_slider', 'newface.processors.modules.face_enhancer'),

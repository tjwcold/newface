...
from newface.common_helper import calculate_float_step
from newface.processors.core import load_processor_module
from newface.processors.modules.face_editor import choices as face_editor_choices
from newface.processors.modules.face_editor.types import FaceEditorModel
from newface.uis.core import get_ui_component, register_ui_component
...
def render() -> None:
	...
	FACE_EDITOR_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_EYEBROW_DIRECTION_SLIDER = gradio.Slider(
		label = translator.get('uis.eyebrow_direction_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_EYE_GAZE_HORIZONTAL_SLIDER = gradio.Slider(
		label = translator.get('uis.eye_gaze_horizontal_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_EYE_GAZE_VERTICAL_SLIDER = gradio.Slider(
		label = translator.get('uis.eye_gaze_vertical_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_EYE_OPEN_RATIO_SLIDER = gradio.Slider(
		label = translator.get('uis.eye_open_ratio_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_LIP_OPEN_RATIO_SLIDER = gradio.Slider(
		label = translator.get('uis.lip_open_ratio_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_MOUTH_GRIM_SLIDER = gradio.Slider(
		label = translator.get('uis.mouth_grim_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_MOUTH_POUT_SLIDER = gradio.Slider(
		label = translator.get('uis.mouth_pout_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_MOUTH_PURSE_SLIDER = gradio.Slider(
		label = translator.get('uis.mouth_purse_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_MOUTH_SMILE_SLIDER = gradio.Slider(
		label = translator.get('uis.mouth_smile_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_MOUTH_POSITION_HORIZONTAL_SLIDER = gradio.Slider(
		label = translator.get('uis.mouth_position_horizontal_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_MOUTH_POSITION_VERTICAL_SLIDER = gradio.Slider(
		label = translator.get('uis.mouth_position_vertical_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_HEAD_PITCH_SLIDER = gradio.Slider(
		label = translator.get('uis.head_pitch_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_HEAD_YAW_SLIDER = gradio.Slider(
		label = translator.get('uis.head_yaw_slider', 'newface.processors.modules.face_editor'),
	...
	FACE_EDITOR_HEAD_ROLL_SLIDER = gradio.Slider(
		label = translator.get('uis.head_roll_slider', 'newface.processors.modules.face_editor'),

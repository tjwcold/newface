...
from newface.processors.modules.background_remover.types import BackgroundRemoverModel
...
def render() -> None:
	...
	BACKGROUND_REMOVER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'newface.processors.modules.background_remover'),
	...
	with gradio.Group(visible = has_background_remover) as BACKGROUND_REMOVER_FILL_COLOR_WRAPPER:
		with gradio.Row():
			BACKGROUND_REMOVER_FILL_COLOR_RED_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_red_number', 'newface.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_FILL_COLOR_GREEN_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_green_number', 'newface.processors.modules.background_remover'),
		...
		with gradio.Row():
			BACKGROUND_REMOVER_FILL_COLOR_BLUE_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_blue_number', 'newface.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_FILL_COLOR_ALPHA_NUMBER = gradio.Number(
				label = translator.get('uis.fill_color_alpha_number', 'newface.processors.modules.background_remover'),
	...
	with gradio.Group(visible = has_background_remover) as BACKGROUND_REMOVER_DESPILL_COLOR_WRAPPER:
		with gradio.Row():
			BACKGROUND_REMOVER_DESPILL_COLOR_RED_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_red_number', 'newface.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_DESPILL_COLOR_GREEN_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_green_number', 'newface.processors.modules.background_remover'),
		...
		with gradio.Row():
			BACKGROUND_REMOVER_DESPILL_COLOR_BLUE_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_blue_number', 'newface.processors.modules.background_remover'),
			...
			BACKGROUND_REMOVER_DESPILL_COLOR_ALPHA_NUMBER = gradio.Number(
				label = translator.get('uis.despill_color_alpha_number', 'newface.processors.modules.background_remover'),

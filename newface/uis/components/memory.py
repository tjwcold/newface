...
from newface.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = newface.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(newface.choices.system_memory_limit_range),
		minimum = newface.choices.system_memory_limit_range[0],
		maximum = newface.choices.system_memory_limit_range[-1],
